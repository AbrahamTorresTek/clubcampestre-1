...
<div class="row">
  ...
  <h2 class="tipo-2 color-1 mayusculas">-</h2>
  <p style="height:10px"></p>  
  </div>  

  <?php $re = mysqli_query($conexion,"SELECT * FROM secciones WHERE dos ='activo' AND doce ='promocion' AND trece ='ingles' order by id ASC");
