<?php
$orgulloll = $_GET['cve']; 
if ($orgulloll == "country-pride") { ?>

<div class="container">
<div class="row" style="padding:50px 20px 50px 20px; display: flex; justify-content: center; flex-wrap: wrap;">

    <?php $redes = mysqli_query($conexion,"SELECT * FROM blog WHERE nueve = 'orgullo' AND dos = 'activo' AND doce ='ingles'");
...
<?php
$orgullol = $_GET['cve']; 
if ($orgullol == "promotions") { ?>

<div class="container">
<div class="row" style="padding:50px 20px 50px 20px; display: flex; justify-content: center; flex-wrap: wrap;">

    <?php $redes = mysqli_query($conexion,"SELECT * FROM blog WHERE nueve = 'promociones' AND dos = 'activo' AND doce ='ingles'");
    while($rowdes=mysqli_fetch_assoc($redes)) { ?>
    <div class="col-xs-12 col-sm-4" style="padding:10px;">
