...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-4 col-sm-offset-4 text-center" style="padding:20px;">
        <?php $re = mysqli_query($conexion,"SELECT * FROM secciones WHERE tres ='si' AND dos ='activo' AND doce ='nosotros' order by id ASC");
        ...
        <div class="" height="<?php echo $alto;?>px" style="padding:0px;">
            ...
            <p class="text-center tipo"><?php $des = substr($row['descripcion'], 0, 400);
                                          echo $des; ?>...</p>
            <p style="height:20px"></p>
            <a href="seccion.php?cve=<?php echo $row['dieciocho']; ?>">
              <div class="tipo-2 mayusculas boton">Ver Más</div>
            </a>
            <!--- NOVE
