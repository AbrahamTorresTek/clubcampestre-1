...
<!--- POP --->
  ...
  <!--- IMG SUPERIOR ---->
  <div class="text-center" style="position:relative; top:0px; left:0px; height:300px; width:100%;">
    ...
    <div class="" style="position:absolute; top:0px; left:0px; height:300px; width:100%; z-index:-1">
      ...
      <img src="secciones/<?php echo $rowsec['f2'];?>" alt="<?php echo $row['siete'];?>" width="100%" style="object-fit:cover; max-width:1500px; height:300px;  border-radius:0px;">
    </div> 
