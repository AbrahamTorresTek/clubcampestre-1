<?php
$seccion = $_GET['cve']; 
$renum = mysqli_query($conexion,"SELECT * FROM blog WHERE dos ='activo' AND cuatro ='$seccion' AND doce ='ingles' AND tres ='destacado' order by id DESC");
...
<div class="row" style="padding:100px 20px 100px 20px;display: flex; justify-content: center; flex-wrap: wrap;">
    ...
    <div class="col-xs-12 col-sm-12 text-center"> 
        <h2 class="tipo-2 color-2 mayusculas"> News Activities and Outstanding Events </h2>
        <p style="height:20px;"></p>
    </div> 

    <?php $redes = mysqli_query($conexion,"SELECT * FROM blog WHERE dos ='activo' AND cuatro ='$seccion' AND doce ='ingles' AND tres ='destacado' order by id DESC");
