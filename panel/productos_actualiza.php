...
include("../conectarse.php");
    ...
    $fdos = $_POST['fdos'];
    $ftres = $_POST['ftres'];
    $fcuatro = $_POST['fcuatro'];

    $descripcion= nl2br($_POST['descripcion']);

    $insersion = mysqli_query($conexion , "UPDATE productos SET id = '$clave' ,uno='$uno' ,dos='$dos' ,tres='$tres' ,cuatro='$cuatro' ,cinco='$cinco' ,seis='$seis' ,siete='$siete' ,ocho='$ocho' ,nueve='$nueve' ,diez='$diez' ,once='$once' ,doce='$doce' ,trece='$trece' ,catorce='$catorce' ,quince='$quince' ,dieciseis='$dieciseis' ,diecisiete='$diecisiete' ,dieciocho='".nl2br($_POST["dieciocho"])."' , descripcion = '".nl2br($_POST["descripcion"])."' ,f1='$funo' ,f2='$fdos' ,f3='$ftres' ,f4='$fcuatro' ,tipo='principal'  where id = '$clave'");
