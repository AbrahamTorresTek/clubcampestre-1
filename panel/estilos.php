      ...
      <div id="content">
           ...
           <div class="row">
                ...
                <div class=" col-xs-12 col-sm-3 text-left">
                  <a href="marcass_todos.php">
                      <button class="btn btn-block btn-warning"> Regresar </button>
                  </a>
                </div>

                <div class=" col-xs-12 col-sm-4 text-left">
                  <h4 class="tipo color"> Alta Nuevo Estilo </h4>
                </div>
            ...
            <!----- FORM ---->
                  ...
                  <form action="estilos_valida.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
...
<!--- NO SE VE 
 ...
 NO SE VE ---->
                        ...
                        <div class=" col-xs-3 text-left">
                              <p><br/></p>
                              <button type="submit" class="btn btn-warning btn-block" value="Enviar"> Guardar</button>
                              <p><br/></p>
                        </div> 
