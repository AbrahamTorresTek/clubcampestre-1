      ...
      <div id="content">
           ...
           <!-- BOTON CERRAR -->
            ...
            <!----- FORM ---->
                ...
                <?php $clave = $_GET['cve']; $re = mysqli_query($conexion,"SELECT * FROM blog WHERE id='$clave'"); while($row = mysqli_fetch_assoc($re)) { ?>  
                <form action="blog_actualiza_foto_1.php?cve2=<?php echo $row['id'];?>" method="post" enctype="multipart/form-data">
