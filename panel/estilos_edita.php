      ...
      <div id="content">
           ...
           <div class="row">
                ...
                <div class=" col-xs-12 col-sm-3 text-left">
                  <a href="estilos_todos.php">
                      <button class="btn btn-block btn-warning"> Regresar </button>
                  </a>
                </div>

                <div class=" col-xs-12 col-sm-4 text-left">
                  <h4 class="tipo color"> Editar estilos </h4>
                </div>
...
<?php $clave = $_GET['cve']; 
$re = mysqli_query($conexion,"SELECT * FROM estilos WHERE id='$clave'");
while($row = mysqli_fetch_assoc($re)) { ?>  

      <form action="estilos_actualiza.php?cve2=<?php echo $row['id'];?>" method="post" enctype="multipart/form-data">
            <div class="row">
...
<!--- NO SE VE 
            ...
            <div class=" col-xs-3 text-left">
                  <h4 class=" tipo">Codigo estilos</h4> 
            ...
            <div class=" col-xs-3 text-left">
                  ...
                  <select name="cinco" id="cinco"  class="form-control">
                        ...
                        <?php $re = mysqli_query($conexion,"SELECT * FROM estilos WHERE estado='activo'  ORDER BY marca ASC");
                              while($row = mysqli_fetch_assoc($re)) { ?>         
      ...
      <div class=" col-xs-10">
            ...
            <div class=" col-xs-3 text-left">
                  <h4 class=" tipo">Categoria de estilos</h4> 
                  <select name="seis" id="seis" required class="form-control">
                        <?php $re = mysqli_query($conexion,"SELECT * FROM estilos WHERE id='$clave'"); while($row = mysqli_fetch_assoc($re)) { ?>
...
<?php $clave = $_GET['cve']; $re = mysqli_query($conexion,"SELECT * FROM estilos WHERE id='$clave'"); while($row = mysqli_fetch_assoc($re)) { ?>  
